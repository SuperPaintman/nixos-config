...
DOTFILES="${DOTFILES:-"/home/superpaintman/Projects/github.com/SuperPaintman/nixos-config"}"
...
dirty curl \
    ...
    https://raw.githubusercontent.com/SuperPaintman/nixos-config/master/hosts/cashapona/hardware-configuration.nix
dirty curl \
    -sL \
    -o /mnt/etc/nixos/hardware-configuration-extra.nix \
    https://raw.githubusercontent.com/SuperPaintman/nixos-config/master/hosts/cashapona/hardware-configuration-extra.nix
...
{
  imports =
    if builtins.pathExists $DOTFILES/hosts/cashapona
    then [
